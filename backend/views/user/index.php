...
<div class="user-index">
	...
	<p>
		...
		<!-- <?= Html::a('Signup User', ['signup-admin'], ['class' => 'btn btn-success']) ?>
        <?= Html::a('User Industri', ['industri'], ['class' => 'btn btn-success']) ?> -->
		<!-- <?= Html::a('admin', ['admini'], ['class' => 'btn btn-success']) ?> -->
	</p>
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-toolbar">
						...
						<p>
							...
							<?= Html::a('Signup Admin', ['signup-admin'], ['class' => 'btn btn-success']) ?>
							<?= Html::a('Add User', ['signup'], ['class' => 'btn btn-primary']) ?>
						</p>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<thead>
							...
							<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
								...
								<th class="">Nama</th>
								<!-- <th class="">Auth Key</th>
													<th class="">Password Hash</th> -->
								<!-- <th class="">Password Reset Token</th> -->
								<th class="">Email</th>
								<!-- <th class="">Status</th>
													<th class="">Created at</th>
													<th class="">Updated at</th>
													<th class="">Verivication Token</th> -->
								<th class="">Role</th>
								<!-- <th class="">Foto Profil</th> -->
								<!-- <th class="">Lokasi PTI</th> -->
								<!-- <th class="">Lokasi Dinas</th> -->
								<th class="">Gelar Depan</th>
								<th class=""> Gelar Belakang</th>
								<th class="">Actions</th>
							</tr>
							<!--end::Table row-->
						</thead>
						...
						<tbody class="fw-bold text-gray-600">
							<?php foreach ($user as $a) { ?>
								<tr>
									...
									<!-- <td><?= $a->password_reset_token ?></td> -->
									<td><?= $a->email ?></td>
									<!-- <td><?= $a->status ?></td>
													<td><?= $a->created_at ?></td>
													<td><?= $a->updated_at ?></td>
													<td><?= $a->verification_token ?></td> -->
									<td><?= $a->role ?></td>
									<!-- <td><?= $a->foto_profil ?></td> -->
									<!-- <td><?= $a->lokasi_pti ?></td> -->
									<!-- <td><?= $a->lokasi_dinas ?></td> -->
									<td><?= $a->gelar_depan ?></td>
