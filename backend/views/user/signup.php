                    ...
                    <div class="col-lg-12">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                ...
                                <button class="nav-link" id="pills-organisasi-tab" data-bs-toggle="pill" data-bs-target="#pills-organisasi" type="button" role="tab" aria-controls="pills-organisasi" aria-selected="false">Organitation</button>

                            </li>
                            <li class="nav-item" role="presentation">

                                <button class="nav-link" id="pills-ngo-tab" data-bs-toggle="pill" data-bs-target="#pills-ngo" type="button" role="tab" aria-controls="pills-dinas" aria-selected="false">Non Profit Organitation</button>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-organisasi" role="tabpanel" aria-labelledby="pills-organisasi-tab">
                                ...
                                <?= $form->field($modelOrganisasiEng, 'nama')->textInput(['placeholder = "Organitation name"' => true]) ?>
                            ...
                            <div class="tab-pane fade" id="pills-ngo" role="tabpanel" aria-labelledby="pills-ngo-tab">
                                ...
                                <?= $form->field($modelNgoEng, 'nama')->textInput(['placeholder = "Non Profit Organitation Name"' => true]) ?>
