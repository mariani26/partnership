...
/** @var backend\models\AboutEngSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Abouts';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="about-eng-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <!-- <?= Html::a('Create About Eng', ['create'], ['class' => 'btn btn-success']) ?> -->
    </p>
    ...
    <!-- <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, AboutEng $model, $key, $index, $column) {
												...
												<tr>
													...
													<td class="text-end">
														<p>
															...
															<?= Html::a('&nbsp; View&nbsp;', ['view', 'id' => $a->id], ['class' => 'btn btn-primary']) ?>
