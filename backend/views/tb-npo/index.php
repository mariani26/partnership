...
/** @var backend\models\TbNpoSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Organisasi Nirlaba';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tb-npo-index">

	<h1><?= Html::encode($this->title) ?></h1>

	<p>
		<!-- <?= Html::a('Create Tb Npo', ['create'], ['class' => 'btn btn-success']) ?> -->
	...
	<!-- <?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'urlCreator' => function ($action, TbNpo $model, $key, $index, $column) {
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						...
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Organisai Nirlaba" />
						</div>
						<!--end::Search-->
					</div>
					<!--begin::Card title-->
					...
					<div class="card-toolbar">
						...
						<p>
							...
							<?= Html::a('Add Organisasi Nirlaba', ['signup'], ['class' => 'btn btn-light-primary']) ?>
						</p>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<thead>
							...
							<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
								...
								<th class="">Nama Organisasi Nirlaba</th>
								<th class="">Bidang</th>
						...
						<tbody class="fw-bold text-gray-600">
							<?php foreach ($tb_npo as $a) { ?>
								<tr>
									...
									<td>
										<?php if ($a->dok_mou) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_npo/mou/' . $a->dok_mou) ?>" id="viewdokmu" target="_blank"><?= $a->dok_mou ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_moa) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_npo/moa/' . $a->dok_moa) ?>" id="viewdokmu" target="_blank"><?= $a->dok_moa ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_imp) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_npo/imp/' . $a->dok_imp) ?>" id="viewdokmu" target="_blank"><?= $a->dok_imp ?></a>
										<?php } ?>
									</td>
									<!-- <td><?= $a->inisiator ?></td>
													<td><?= $a->keterangan ?></td> -->
