...
/** @var backend\models\TbDinasSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Dinas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tb-dinas-index">

	<h1><?= Html::encode($this->title) ?></h1>

	<p>
		<!-- <?= Html::a('Create Tb Dinas', ['create'], ['class' => 'btn btn-success']) ?>
	...
	<!-- <?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'urlCreator' => function ($action, TbDinas $model, $key, $index, $column) {
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						...
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Dinas" />
						</div>
						<!--end::Search-->
					</div>
					<!--begin::Card title-->
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
							<p>
								...
								<?= Html::a('Add Dinas', ['signup'], ['class' => 'btn btn-light-primary']) ?>
							</p>
						</div>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
						...
						<tbody class="fw-bold text-gray-600">
							<?php foreach ($tb_dinas as $a) { ?>
								<tr>
									...
									<td>
										<?php if ($a->dok_mou) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_dinas/mou/' . $a->dok_mou) ?>" id="viewdokmu" target="_blank"><?= $a->dok_mou ?></a>
											<!-- <iframe id="iframedokmu" style="" src="uploads_dinas/mou/<?= $a->dok_mou ?>" frameborder="1" height="100px" width="200px"></iframe> -->
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_moa) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_dinas/moa/' . $a->dok_moa) ?>" id="viewdokmu" target="_blank"><?= $a->dok_moa ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_imp) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_dinas/imp/' . $a->dok_imp) ?>" id="viewdokmu" target="_blank"><?= $a->dok_imp ?></a>
										<?php } ?>
									</td>
