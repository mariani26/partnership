...
<head>
    ...
    <link rel="shortcut icon" href="<?= Yii::$app->getHomeUrl(); ?>assets/media/logos/Logo-UPN-Universitas-Negeri-Padang-PNG.png" />
    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
    <!--end::Fonts-->

    <!--begin::Page Vendor Stylesheets(used by this page)-->
    <link href="<?= Yii::$app->getHomeUrl(); ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?= Yii::$app->getHomeUrl(); ?>assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
    <!--end::Page Vendor Stylesheets-->
    <!--begin::Global Stylesheets Bundle(used by all pages)-->
    <link href="<?= Yii::$app->getHomeUrl(); ?>assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?= Yii::$app->getHomeUrl(); ?>assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="<?= Yii::$app->getHomeUrl(); ?>index.php">
                        <img alt="Logo" src="<?= Yii::$app->getHomeUrl(); ?>assets/media/logos/Partnership.png" class="h-25px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                            <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                ...
                                <!-- </span> -->
                                <!-- <div class=""> -->
                                <!-- <a href="<?= Url::toRoute(['site/index']) ?>">Dashboards</a> -->
                                <!-- <a href="<?= Yii::$app->getHomeUrl(); ?>index.php">Dashboards</a> -->
                                ...
                                <?php if (Yii::$app->user->identity->role == 'superadmin') { ?>
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_industri' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-industri']) ?>">
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_sekolah' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-sekolah']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_dinas' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-dinas']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Pemerintah</span>
                                                    </a>
                                                </li>
                                            </div>
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_perguruan_tinggi' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-perguruan-tinggi']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_npo' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-npo']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Organisasi Nirlaba</span>
                                                    </a>
                                                </li>
                                            </div>
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_organisasi' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-organisasi']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'user' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/user']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'faq' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/faq']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'about' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/about']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'choose' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/choose']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Non Indonesia</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">

                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_industri_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-industri-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_sekolah_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-sekolah-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_dinas_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-dinas-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_perguruan_tinggi_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-perguruan-tinggi-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_npo_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-npo-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Non Profit Organization (NPO)</span>
                                                    </a>
                                                </li>
                                            </div>
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_organisasi_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-organisasi-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'tb_student_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/tb-student-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'faq_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/faq-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">FAQ</span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'about_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/about-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">About Us</span>
                                            ...
                                            <div class="menu-item">
                                                <li <?= Yii::$app->controller->id == 'choose_eng' ? 'class=active' : '' ?>>
                                                    <a class="menu-link" href="<?= Url::toRoute(['/choose-eng']) ?>">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
                                                        <span class="menu-title">Choose</span>
                            ...
                            <div class="">
                                <a href="<?= Url::toRoute(['site/logout']) ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sign Out</a>
                            </div>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="<?= Yii::$app->getHomeUrl(); ?>index.php" class="d-lg-none">
                                <img alt="Logo" src="assets/media/logos/Logo-UPN-Universitas-Negeri-Padang-PNG.png" class="h-30px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                        <!--begin::Wrapper-->
                        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                            ...
                            <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <!-- <a class="btn btn-icon btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" href="documentation/getting-started/dark-mode.html">
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        <img src="<?= Yii::$app->getHomeUrl(); ?>assets/media/avatars/300-1.jpg" alt="user" />
                                    </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="<?= Yii::$app->getHomeUrl(); ?>assets/media/avatars/300-1.jpg" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5"><?php echo Yii::$app->user->identity->username; ?></span>
                                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"></span>
                                                    </div>
                                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7"><?php echo Yii::$app->user->identity->email; ?></span></a>
                                                </div>
                                                <!--end::Username-->
                                            </div>
                                        </div>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <!--end::Toolbar-->
                    <!--begin::Post-->
                    <div class="container" id="kt_post">
                        <!--begin::Container-->
                        <?= $content ?>
                        <!--end::Container-->
                    </div>
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Partnership-UNP</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
    ...
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/plugins/global/plugins.bundle.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/scripts.bundle.js"></script>
    <!--end::Global Javascript Bundle-->
    <!--begin::Page Vendors Javascript(used by this page)-->
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/plugins/custom/datatables/datatables.bundle.js"></script>
    <!--end::Page Vendors Javascript-->
    <!--begin::Page Custom Javascript(used by this page)-->
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/widgets.bundle.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/custom/widgets.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/custom/apps/chat/chat.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/custom/utilities/modals/upgrade-plan.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/custom/utilities/modals/create-app.js"></script>
    <script src="<?= Yii::$app->getHomeUrl(); ?>assets/js/custom/utilities/modals/users-search.js"></script>
