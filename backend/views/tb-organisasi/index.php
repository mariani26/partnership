...
/** @var backend\models\TbOrganisasiSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Organisasi';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tb-organisasi-index">

	<h1><?= Html::encode($this->title) ?></h1>

	<p>
		<!-- <?= Html::a('Create Tb Organisasi', ['create'], ['class' => 'btn btn-success']) ?>
	...
	<!-- <?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'urlCreator' => function ($action, TbOrganisasi $model, $key, $index, $column) {
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						...
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Organisasi" />
						</div>
						<!--end::Search-->
					</div>
					<!--begin::Card title-->
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
							<p>
								...
								<?= Html::a('Add Organisasi', ['signup'], ['class' => 'btn btn-light-primary']) ?>
							</p>
						</div>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
				...
				<div class="card-body pt-0">
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<tbody class="fw-bold text-gray-600">
							<?php foreach ($tb_organisasi as $a) { ?>
								<tr>
									<!--begin::Checkbox-->
									<td>
									...
									<td>
										<?php if ($a->dok_mou) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_organisasi/mou/' . $a->dok_mou) ?>" id="viewdokmu" target="_blank"><?= $a->dok_mou ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_moa) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_organisasi/moa/' . $a->dok_moa) ?>" id="viewdokmu" target="_blank"><?= $a->dok_moa ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_imp) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_organisasi/imp/' . $a->dok_imp) ?>" id="viewdokmu" target="_blank"><?= $a->dok_imp ?></a>
										<?php } ?>
									</td>
									<!-- <td><?= $a->inisiator ?></td>
													<td><?= $a->keterangan ?></td> -->
