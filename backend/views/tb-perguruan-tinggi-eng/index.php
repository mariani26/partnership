...
/** @var backend\models\TbPerguruanTinggiEngSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Colleges';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tb-perguruan-tinggi-eng-index">
	...
	<!-- <?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'urlCreator' => function ($action, TbPerguruanTinggiEng $model, $key, $index, $column) {
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						...
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search College" />
						</div>
						<!--end::Search-->
					</div>
					<!--begin::Card title-->
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
							<p>
								...
								<?= Html::a('Add College', ['signupeng'], ['class' => 'btn btn-light-primary']) ?>
							</p>
						</div>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
				...
				<div class="card-body pt-0">
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<tbody class="fw-bold text-gray-600">
							<?php foreach ($tb_perguruan_tinggi_eng as $a) { ?>
								<tr>
									<!--begin::Checkbox-->
									<td>
									...
									<td>
										<?php if ($a->doc_mou) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_perguruan_tinggi_eng/mou/' . $a->doc_mou) ?>" id="viewdokmu" target="_blank"><?= $a->doc_mou ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->doc_moa) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_perguruan_tinggi_eng/moa/' . $a->doc_moa) ?>" id="viewdokmu" target="_blank"><?= $a->doc_moa ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->doc_imp) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_perguruan_tinggi_eng/imp/' . $a->doc_imp) ?>" id="viewdokmu" target="_blank"><?= $a->doc_imp ?></a>
										<?php } ?>
									</td>
									<!-- <td><?= $a->initiator ?></td>
													<td><?= $a->description ?></td> -->
