...
/** @var backend\models\TbSekolahSearch $searchModel */
...
<div class="tb-sekolah-index">
	...
	<p>
		<!-- <?= Html::a('Create Tb Sekolah', ['create'], ['class' => 'btn btn-success']) ?> -->
	...
	<!-- <?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'urlCreator' => function ($action, TbSekolah $model, $key, $index, $column) {
				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-title">
						...
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Sekolah" />
						</div>
						<!--end::Search-->
					</div>
					<!--begin::Card title-->
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
							<p>
								...
								<?= Html::a('Add Sekolah', ['signup'], ['class' => 'btn btn-light-primary']) ?>
							</p>
						</div>
						<!--end::Toolbar-->
						<!--begin::Group actions-->
						...
						<tbody class="fw-bold text-gray-600">
							<?php foreach ($tb_sekolah as $a) { ?>
								<tr>
									...
									<td>
										<?php if ($a->dok_mou) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_sekolah/mou/' . $a->dok_mou) ?>" id="viewdokmu" target="_blank"><?= $a->dok_mou ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_moa) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_sekolah/moa/' . $a->dok_moa) ?>" id="viewdokmu" target="_blank"><?= $a->dok_moa ?></a>
										<?php } ?>
									</td>
									<td>
										<?php if ($a->dok_imp) { ?>
											<a href="<?= Yii::getAlias('@web/uploads_sekolah/imp/' . $a->dok_imp) ?>" id="viewdokmu" target="_blank"><?= $a->dok_imp ?></a>
										<?php } ?>
									</td>
									<!-- <td><?= $a->inisiator ?></td>
													<td><?= $a->keterangan ?></td> -->
