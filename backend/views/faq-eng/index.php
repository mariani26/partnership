...
/** @var backend\models\FaqEngSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Faqs';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="faq-eng-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <!-- <?= Html::a('Create Faq Eng', ['create'], ['class' => 'btn btn-success']) ?> -->
    </p>
    ...
    <!-- <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, FaqEng $model, $key, $index, $column) {
