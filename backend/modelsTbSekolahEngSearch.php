...
/**
 * modelsTbSekolahEngSearch represents the model behind the search form of `backend\models\TbSekolahEng`.
 */
class modelsTbSekolahEngSearch extends TbSekolahEng
{
    /**
     * {@inheritdoc}
     */
