...
/**
 * TbPerguruanTinggiSearch represents the model behind the search form of `backend\models\TbPerguruanTinggi`.
 */
class TbPerguruanTinggiSearch extends TbPerguruanTinggi
{
    /**
     * {@inheritdoc}
     */
