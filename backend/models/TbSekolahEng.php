...
/**
 * This is the model class for table "tb_sekolah_eng".
 *
 * @property int $id
 ...
 */
class TbSekolahEng extends \yii\db\ActiveRecord
{
    public $mou;
    public $moa;
    public $imp;
    ...
    {
        return [
            [['school_name', 'main_email', 'user_id'], 'required'],
            [['start_date', 'end_date'], 'safe'],
            [['address', 'map_link', 'facebook_link', 'instagram_link', 'twitter_link', 'youtube_link'], 'string'],
            [['user_id'], 'integer'],
            [['school_name', 'cooperation_field', 'collaboration_title', 'type_of_cooperation', 'collaboration_year_number', 'doc_mou', 'doc_moa', 'doc_imp', 'initiator', 'main_email', 'website', 'city', 'state', 'country'], 'string', 'max' => 255],
