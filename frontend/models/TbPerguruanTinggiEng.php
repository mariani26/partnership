...
/**
 * This is the model class for table "tb_perguruan_tinggi_eng".
 *
 * @property int $id
 ...
 */
class TbPerguruanTinggiEng extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tb_perguruan_tinggi_eng';
    }
    ...
    {
        return [
            [['college_name', 'user_id'], 'required'],
            [['start_date', 'end_date'], 'safe'],
            [['address', 'map_link', 'facebook_link', 'instagram_link', 'twitter_link', 'youtube_link'], 'string'],
            [['user_id'], 'integer'],
            [['college_name', 'collaboration_title', 'cooperation_field', 'type_of_cooperation', 'collaboration_year_number', 'doc_mou', 'doc_moa', 'doc_imp', 'initiator', 'faculty', 'main_email', 'website', 'city', 'state', 'country'], 'string', 'max' => 255],
