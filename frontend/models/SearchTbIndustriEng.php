...
/**
 * SearchTbIndustriEng represents the model behind the search form of `frontend\models\TbIndustriEng`.
 */
class SearchTbIndustriEng extends TbIndustriEng
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'user_id'], 'integer'],
            [['industry_name', 'identity_number', 'director_identity', 'business_fields', 'collaboration_title', 'type_of_cooperation', 'collaboration_year_number', 'start_date', 'end_date', 'doc_mou', 'doc_moa', 'doc_imp', 'initiator', 'description', 'main_email', 'backup_email', 'phone_number', 'fax_number', 'website', 'address', 'city', 'state', 'country', 'zipcode', 'contact_person', 'map_link', 'facebook_link', 'instagram_link', 'twitter_link', 'youtube_link'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'industry_name', $this->industry_name])
            ...
            ->andFilterWhere(['like', 'director_identity', $this->director_identity])
