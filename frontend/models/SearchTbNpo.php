...
use frontend\models\TbNpo;

/**
 * SearchTbNpo represents the model behind the search form of `frontend\models\TbNpo`.
 */
class SearchTbNpo extends TbNpo
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'id_user'], 'integer'],
            [['nama_npo', 'bidang_npo', 'judul_kerjasama', 'jenis_kerjasama', 'no_thn_kerjasama', 'tgl_mulai', 'tgl_akhir', 'dok_mou', 'dok_moa', 'dok_imp', 'inisiator', 'keterangan', 'email', 'no_telp', 'no_fax', 'website', 'alamat', 'kelurahan', 'kecamatan', 'kota', 'kode_pos', 'rt_rw', 'kontak_person', 'link_maps', 'link_facebook', 'link_instagram', 'link_twitter', 'link_youtube'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'nama_npo', $this->nama_npo])
            ->andFilterWhere(['like', 'bidang_npo', $this->bidang_npo])
