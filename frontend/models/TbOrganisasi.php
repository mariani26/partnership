...
/**
 * This is the model class for table "tb_organisasi".
 *
 * @property int $id
 * @property string $nama_organisasi
 * @property string|null $bidang_organisasi
 ...
 * @property User $user
 */
class TbOrganisasi extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['nama_organisasi', 'id_user'], 'required'],
            [['tgl_mulai', 'tgl_akhir'], 'safe'],
            [['alamat', 'link_maps', 'link_facebook', 'link_instagram', 'link_twitter', 'link_youtube'], 'string'],
            [['id_user'], 'integer'],
            [['nama_organisasi', 'bidang_organisasi', 'judul_kerjasama', 'jenis_kerjasama', 'no_thn_kerjasama', 'dok_mou', 'dok_moa', 'dok_imp', 'inisiator', 'email_utama', 'website', 'kelurahan', 'kecamatan', 'kota'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'bidang_organisasi' => 'Bidang Organisasi',
