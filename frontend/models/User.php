...
class User extends \yii\db\ActiveRecord
{
    ...
    public function getTbDinasEng()
    {
        return $this->hasMany(TbDinasEng::class, ['id_user' => 'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTbIndustrisEng()
    {
        return $this->hasMany(TbIndustriEng::class, ['id_user' => 'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTbNposEng()
    {
        return $this->hasMany(TbNpoEng::class, ['id_user' => 'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTbOrganisasisEng()
    {
        return $this->hasMany(TbOrganisasiEng::class, ['id_user' => 'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTbPerguruanTinggisEng()
    {
        return $this->hasMany(TbPerguruanTinggiEng::class, ['id_user' => 'id']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTbSekolahsEng()
    {
        return $this->hasMany(TbSekolahEng::class, ['id_user' => 'id']);
    }

    /**
     * Gets query for [[TbStudents]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getTbStudentsEng()
    {
        return $this->hasMany(TbStudentEng::class, ['id_user' => 'id']);
    }
}
