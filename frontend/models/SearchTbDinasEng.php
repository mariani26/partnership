...
/**
 * SearchTbDinasEng represents the model behind the search form of `frontend\models\TbDinasEng`.
 */
class SearchTbDinasEng extends TbDinasEng
{
    /**
     * {@inheritdoc}
     */
