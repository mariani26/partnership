 ...
 * @property int|null $dok_mou
 * @property int|null $dok_moa
 * @property int|null $dok_imp
 * @property int|null $inisiator
...
class TbPerguruanTinggi extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_peguruan_tinggi', 'bidang_kerjasama', 'judul_kerjasama', 'jenis_kerjasama', 'no_thn_kerjasama', 'fakultas', 'email_utama', 'website', 'kelurahan', 'kecamatan', 'kota'], 'string', 'max' => 255],
