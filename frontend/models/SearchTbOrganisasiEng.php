...
/**
 * SearchTbOrganisasiEng represents the model behind the search form of `frontend\models\TbOrganisasiEng`.
 */
class SearchTbOrganisasiEng extends TbOrganisasiEng
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'organization_name', $this->organization_name])
            ->andFilterWhere(['like', 'organizational_field', $this->organizational_field])
