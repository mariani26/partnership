...
/**
 * SearchTbPerguruanTinggiEng represents the model behind the search form of `frontend\models\TbPerguruanTinggiEng`.
 */
class SearchTbPerguruanTinggiEng extends TbPerguruanTinggiEng
{
    /**
     * {@inheritdoc}
     */
