...
use frontend\models\TbDinas;

/**
 * SearchTbDinas represents the model behind the search form of `frontend\models\TbDinas`.
 */
class SearchTbDinas extends TbDinas
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            [['id', 'id_user'], 'integer'],
            [['nama_dinas', 'bidang_kerjasama', 'judul_kerjasama', 'jenis_kerjasama', 'no_thn_kerjasama', 'tgl_mulai', 'tgl_akhir', 'dok_mou', 'dok_moa', 'dok_imp', 'inisiator', 'keterangan', 'email_utama', 'no_telp', 'no_fax', 'website', 'alamat', 'kelurahan', 'kecamatan', 'kota', 'kode_pos', 'rt_rw', 'kontak_person', 'link_maps', 'link_facebook', 'link_instagram', 'link_twitter', 'link_youtube'], 'safe'],
        ];
    }
