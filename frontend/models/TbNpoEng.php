...
/**
 * This is the model class for table "tb_npo_eng".
 *
 * @property int $id
 * @property string $npo_name
 * @property string|null $npo_field
 ...
 */
class TbNpoEng extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['npo_name', 'user_id'], 'required'],
            [['start_date', 'end_date'], 'safe'],
            [['address', 'map_link', 'facebook_link', 'instagram_link', 'twitter_link', 'youtube_link'], 'string'],
            [['user_id'], 'integer'],
            [['npo_name', 'npo_field', 'collaboration_title', 'type_of_cooperation', 'collaboration_year_number', 'doc_mou', 'doc_moa', 'doc_imp', 'initiator', 'description', 'email', 'website', 'city', 'state', 'country'], 'string', 'max' => 255],
