        ...
        <div class="row">
            <div class="col ">
                <div class="container-fluid position-relative">
                    <div class="py-4 bg-light left-0 z-index-3 w-100" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'padding': {'top': 70}}">
                        <div class="text-center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="400" data-appear-animation-duration="750">
                            <ul class="nav nav-pills sort-source sort-source-style-3 justify-content-center mb-0" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*', 'useHash': false}">
                                <li class="nav-item " data-option-value=".classic"><a class="nav-link custom-nav-link " href="<?= Url::toRoute(['/profile/akun']) ?>" data-hash data-hash-offset="0" data-hash-offset-lg="-200">Update Profile</a></li>
                                ...
                                <li class="nav-item" data-option-value=".classic"><a class="nav-link custom-nav-link" href="<?= Url::toRoute(['/profile/profil']) ?>" data-hash data-hash-offset="0" data-hash-offset-lg="-200">Profile</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <?php if (Yii::$app->user->identity->role == 'sekolah') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_sekolah', [
                                    'tbSekolah' => $tbSekolah
                                ]) ?>
                                <?php \yii\widgets\Pjax::end() ?>
                            </div>
                    ...
                    <?php if (Yii::$app->user->identity->role == 'PT') { ?>
                        <div class="card bg-primary">
                            <div class="card-header text-center bg-secondary">
                                <h2 style="color: white;"> Lengkapi Data </h2>
                            </div>
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_perguruan_tinggi', [
                    ...
                    <?php if (Yii::$app->user->identity->role == 'organisasi') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_organisasi', [
            ...
            <div class="col ">
                <div class="container-fluid position-relative">
                    <div class="py-4 bg-light left-0 z-index-3 w-100" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'padding': {'top': 70}}">
                        <div class="text-center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="400" data-appear-animation-duration="750">
                            <ul class="nav nav-pills sort-source sort-source-style-3 justify-content-center mb-0" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*', 'useHash': false}">
                                <li class="nav-item " data-option-value=".classic"><a class="nav-link custom-nav-link " href="<?= Url::toRoute(['/profile/akuneng']) ?>" data-hash data-hash-offset="0" data-hash-offset-lg="-200">Update Profile</a></li>
                                <li class="nav-item active" data-option-value=".new"><a class="nav-link custom-nav-link" href="<?= Url::toRoute(['/profile/indexeng']) ?>" data-hash data-hash-offset="0" data-hash-offset-lg="-200">Complete Data</a></li>
                    ...
                    <?php if (Yii::$app->user->identity->role == 'industrieng') { ?>
                        <div class="card bg-primary">
                            <div class="card-header text-center bg-secondary">
                                <h2 style="color: white;"><b> Complete Data </b></h2>
                            </div>
                            <div class="card-body">
                                <?php \yii\widgets\Pjax::begin([
                                    'enablePushState' => false
                                ]) ?>
                                <?php echo $this->render('tb_industrieng', [
                    ...
                    <?php if (Yii::$app->user->identity->role == 'sekolaheng') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_sekolaheng', [
                    ...
                    <?php if (Yii::$app->user->identity->role == 'PTeng') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_perguruan_tinggieng', [
                    ...
                    <?php if (Yii::$app->user->identity->role == 'dinaseng') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_dinaseng', [
                    ...
                    <?php if (Yii::$app->user->identity->role == 'organisasieng') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_organisasieng', [
                    ...
                    <?php if (Yii::$app->user->identity->role == 'NPOeng') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_npoeng', [
                                    'tbNpoEng' => $tbNpoEng
                                ]) ?>
                                <?php \yii\widgets\Pjax::end() ?>
                            </div>
                    ...
                    <?php if (Yii::$app->user->identity->role == 'studenteng') { ?>
                        <div class="card bg-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo $this->render('tb_studenteng', [
