...
/** @var frontend\models\SearchTbIndustriEng $model */
/** @var yii\widgets\ActiveForm $form */
?>

<div class="tb-industri-eng-search">
    ...
    <?= $form->field($model, 'industry_name')->textInput(['placeholder = "Search..."' => true]) ?>

    <?php // echo $form->field($model, 'identity_number') 
    ?>

    <?php // echo $form->field($model, 'director_identity') 
    ?>

    <?php // echo $form->field($model, 'business_fields') 
    ?>

    <?php // echo $form->field($model, 'collaboration_title') 
    ?>

    <?php // echo $form->field($model, 'type_of_cooperation') 
    ?>
    ...
    <?php // echo $form->field($model, 'backup_email') 
    ?>
